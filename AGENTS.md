...
Guidance for AI coding agents working in **hasharium**.

## Project overview

A deterministic DID-hash specimen collection.
...
Sync AGENTS.md from zincfox; Sync CONTRIBUTING.md from zincfox; Sync AGENTS.md from zincfox; Sync CONTRIBUTING.md from zincfox; Symlink droid/opencode/qwen/rovodev skill dirs to .agents/skills